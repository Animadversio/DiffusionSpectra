...
outdir = r"F:\insilico_exps\Diffusion_traj\MNIST_PCA_theory_DDIM_hybrid"
os.makedirs(outdir, exist_ok=True)
for seed in tqdm(range(225, 400)):
    ...
    #
    # plt.subplot(131)
    # plt.imshow(norm2img(sample_traj[-1].permute(1, 2, 0)))
    # plt.subplot(132)
    # plt.imshow(norm2img(sample_hybrid[0].cpu().detach().permute(1, 2, 0)))
    # plt.subplot(133)
    # plt.imshow(norm2img(x0hatxt_traj[-1].reshape(3, 32, 32).permute(1, 2, 0)))
    # plt.show()
