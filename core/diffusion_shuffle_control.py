"""Shuffled version of UZNet
Shuffled UNet will not travel in 2d space"""
import torch
...
saveroot = rf"F:\insilico_exps\Diffusion_traj\{model_id_short}_shuffle"
...
#%%
"""Shuffle the weights of all parameters in the model"""
state_dict = pipe.unet.state_dict()
state_dict_shuffled = {}
for k, v in state_dict.items():
    state_dict_shuffled[k] = v.view(-1)[torch.randperm(v.nelement())].view(v.shape)
    print(k, v.shape)
#%%
pipe.unet.load_state_dict(state_dict_shuffled)
