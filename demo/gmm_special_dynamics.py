...
plt.scatter(x0_col[:, 0], x0_col[:, 1], s=40, c="b", alpha=0.3)
plt.scatter(xT_col[:, 0], xT_col[:, 1], s=40, c="k", alpha=0.1)
plt.scatter(mus[:, 0], mus[:, 1], s=64, c="r", alpha=0.7)
plt.axis("image")
plt.tight_layout()
plt.show()
#%%
...
plt.figure(figsize=(8, 8))
plt.scatter(x0_col[:, 0], x0_col[:, 1], c="b", alpha=0.3)
plt.scatter(xT_col[:, 0], xT_col[:, 1], c="k", alpha=0.1)
plt.scatter(mus[:, 0], mus[:, 1], s=50, c="r", alpha=0.7)
plt.axis("image")
plt.tight_layout()
plt.show()
#%%
